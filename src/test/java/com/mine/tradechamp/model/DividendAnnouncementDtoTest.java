...
public class DividendAnnouncementDtoTest {
	DividendAnnouncementDto divPay; 
	
	private Logger logger = LoggerFactory.getLogger(DividendAnnouncementDtoTest.class);
	...
	public void beforeTest(Long id, String stockSymbol, double declaredAmount, String declaredDateStr, String exDividendDateStr, String payDateStr, String dividendFrequency) {
		...
		divPay = new DividendAnnouncementDto(id, stockSymbol, declaredAmount, LocalDate.parse(declaredDateStr), LocalDate.parse(exDividendDateStr), LocalDate.parse(payDateStr), dividendFrequency);
	}
